        ...
        <?php $no=1; foreach ($penyebaran as $key => $value) { ?>
            <tr>
                ...
                <td>
                    ...
                    <a href="#" data-target="#modal<?= $value->id?>" data-toggle="modal" class="btn btn-xs btn-default fa fa-image text-center"</a>
                </td>
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <center><h2 class="modal-title" id="exampleModalLabel">Gambar Terkait</h2></center>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close" style="margin-top: -35px; font-size: 30px;">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                  <div class="modal-body" style="text-align: center;">
                    <img src="<?= base_url() ?>template/assets/foto/<?= $value->foto?>" alt="" width="400px" height="300px">
                  </div>
